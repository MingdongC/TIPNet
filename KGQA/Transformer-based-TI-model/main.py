        ...
        for phase in phases:
            if phase == 'train':
                ...
                for i_batch, a in enumerate(loader):
                    ...
                    loss = model(question_tokenized=question_tokenized,attention_mask=attention_mask, p_head=positive_head, p_tail=positive_tail, words_ti_value= words_ti_value)
                    loss.backward()
