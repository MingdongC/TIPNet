...
class DatasetMetaQA(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return question_tokenized, attention_mask, head_id, tail_onehot, torch.tensor(words_ti_values, dtype=torch.float32), torch.tensor(rel_id, dtype=torch.long)
...
def _collate_fn(batch):
    ...
    words = torch.zeros((minibatch_size, longest_sample), dtype=torch.long)
